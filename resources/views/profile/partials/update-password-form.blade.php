<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div class="mb-5">
            <label for="update_password_current_password" :value="__('Current Password')">Current Password <span class="text-danger">*</span></label>
        ...
        <div class="mb-5">
            <label for="update_password_password" :value="__('New Password')">New Password <span class="text-danger">*</span></label>
        ...
        <div class="mb-5">
            <label for="update_password_password_confirmation" :value="__('Confirm Password')">Confirm Password <span class="text-danger">*</span></label>
